                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="shop.html" class="font-dark">Sepatu Baru</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Jeans Bermerek</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Jaket Baru</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Hoodie Warna-warni</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Kacamata Bersinar</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="#" class="font-dark">Pesanan Anda</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">Akun Anda</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">Lacak Pesanan</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">Daftar Keinginan Anda</a>
                                    </li>
                                    <li>
                                        <a href="#" class="font-dark">FAQ Belanja</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
