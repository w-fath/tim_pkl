                                ...
                                <div class="accordion-body category-scroll">
                                    <ul class="category-list">
                                        @foreach ($categories as $category)
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="ct{{$category->id}}" name="categories" type="checkbox" @if(in_array($category->id,explode(',',$q_categories))) checked="checked" @endif value="{{$category->id}}" onchange="filterProductsByCatogory(this)">
                                ...
                                <div class="page-view-filter">
                                    <div class="dropdown select-featured">
                                        <select class="form-select" name="orderby" id="orderby">
                                            ...
                                            <option value="1" {{$order==1? 'selected':''}}>Baru ke Lama</option>
                                            <option value="2"{{$order==-2? 'selected':''}}>Lama ke Baru</option>
                                            <option value="3"{{$order==-3? 'selected':''}}>Rendah ke Tinggi</option>
                                            <option value="4"{{$order==-4? 'selected':''}}>Tinggi ke Rendah</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="dropdown select-featured">
...
@push('scripts')
    <script>
        ...
        function filterProductsByCatogory(brand) {
            var categories = "";
